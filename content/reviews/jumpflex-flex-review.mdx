...
The Jumpflex FLEX is designed for a maximum of 100 kg per jumper, with a separate 150 kg combined total weight rating. Positive feedback from users suggests that the trampoline delivers good bounce quality and an overall satisfying and fun experience.
...
The Flex comes with a 5-year frame warranty and 1-year warranties on the springs, mat, safety net and pads. Longer warranties on the non-frame components would be welcome, but these terms are fairly typical for models in this price range.
...
With an easy assembly process, a 100 kg maximum per jumper, a 150 kg combined total rating and optional accessories for added fun, it represents good value for money.
