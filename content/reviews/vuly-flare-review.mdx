...
![A Vuly Flare trampoline installed in a backyard](/images/posts/vuly-flare-3.jpg)
...
Vuly lists a 100 kg maximum single-user weight for both Flare sizes, below the 120 to 150 kg per-jumper ratings on Vuly's other current models.
...
The Flare uses conventional coil springs to provide its bounce. Vuly does not publish a spring count or spring length for this model.

Its performance is generally described as satisfactory by users; however, the 100 kg single-user limit and two-size range position it below Vuly's larger current models. Our expert echoes its appeal for younger users, stating it is “great for small kids”.
...
Priced from $499, the Vuly Flare positions itself as an entry-level option that balances cost against features and durability. According to our expert, it's "good if you don't know if the kids will use a trampoline and don't want to spend a lot of money."
