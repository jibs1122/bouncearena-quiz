...
**Previous-generation model:** This review covers the superseded Vuly Ultra, not the current Ultra 2. It remains useful for existing owners and second-hand buyers. If you are buying new, [view Vuly's current range](/go/vuly) and compare the [Ultra 2 with the Ultra 2 Pro](/compare/vuly-ultra-2-vs-ultra-2-pro/).
