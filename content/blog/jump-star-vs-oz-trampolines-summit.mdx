...
![Oz Trampolines OzUltimate round trampoline](/images/oz-trampolines/ozultimate-round.jpg)

## Durability and Weather Resistance

Both trampolines use galvanised steel frames for outdoor durability. Oz Trampolines note that the Summit has been specifically designed for harsh Australian conditions with materials UV-tested for 5,000 hours.
...
The Summit package includes a 3-step powder-coated ladder, galvanised steel anchor kit, safety book for children, and a net pocket for storing small items.
