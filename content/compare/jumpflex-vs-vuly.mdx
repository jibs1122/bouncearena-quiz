...
Jumpflex and Vuly overlap on price but differ on almost everything else. Every Vuly model is listed as meeting the Australian Trampoline Standard AS 4989:2015. No Jumpflex model is. If the Australian standard is a requirement in your household, only Vuly qualifies.
